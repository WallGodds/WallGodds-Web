...
_A brief overview of the project idea, its purpose, and why it matters_

The goal of this project is to modernize and optimize the **WallGodds-Web** application. Currently, the codebase suffers from significant code duplication (separate components for Mobile, Tablet, and Desktop) and lacks the type safety of modern web standards.
...
_Explain how the project will help the Organization_
...
_Briefly discuss your plan, how you wish to complete this project, including the tech stack you'll be using_
...
_A bullet-point list of specific deliverables to be achieved by the end of the contribution timeline_
